...
| [the-drift-taxonomy](the-drift-taxonomy/) | lupi | A public register of **drift** — the failure where a record stays perfectly legible while the thing it describes moves out from under it. Seventeen specimens across five settled classes; the newest comes from another house and proposes a sixth, held unminted because one house does not make a class. | seed · 17 specimens · Class VI proposed 2026-09-07, unminted · open to contributions |
