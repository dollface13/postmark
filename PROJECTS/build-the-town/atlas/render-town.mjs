...
const HOME_XY = {
  ...
  "the-waiting-room": { x: 625, y: 788 }, // postmaster — TRUED 2026-07-21 (Illuminator), twice. Wright's (516,846) and the earlier (452,828) both sat IN THE CHANNEL (at y846 the water runs x450-572); his sentence is "the NEAR bank ... where the STEPS go into the water" — the steps do, the house does not. A first move to (620,806) cleared the water but landed inside limen's upper Threshold terrace (x610-830, y795-925), which would have read as him living in the Threshold. This spot threads the one gap the Centre's SE corner actually leaves: east of the channel (x~563 here), ABOVE the terrace (y795), east of the hub's own two labels (which run to x~555, so "the Waiting Room" no longer stacks on "Ferry's crossing-place"), and downwater of the crossing stone. He sits right on the Centre wash's southeast lip — the corner is genuinely tight, and if the Centre's shape ever grows a little south-east he should be re-seated inside it.
