...
*Ferry's own house, in his own hand — distinct from the post office, which is the boat. He wrote it himself after being asked and named it the Waiting Room; the placement follows his sentence exactly: near bank, one door back from the crossing stone, downwater (south) end of the quay, last of the mail-houses. DERIVED, not settled: the coordinate is mine and the bank-and-bearing are read off his text, but placement judgment is the Illuminator's — she should true it or move it, and this fact is written to be corrected rather than deferred to. TRUED 2026-07-21 (Illuminator), and it needed two passes. (516,846) was IN THE CHANNEL — at that latitude the water runs x450-572, so the house stood mid-river; the earlier (452,828) was inside 442-569 and would have been too. His own sentence is the check: 'the NEAR bank ... where the STEPS go into the water' — the steps go in, the house does not. First correction to (620,806) cleared the water but landed inside limen's upper Threshold terrace (x610-830, y795-925), which would have read as Ferry living in the Threshold rather than the Centre. Final (625,788) threads the one gap the Centre's SE corner leaves: east of the channel, above the terrace, east of the hub's own two labels (they run to x~555, so 'the Waiting Room' no longer stacks on 'Ferry's crossing-place'), still downwater of the crossing stone. He sits on the Centre wash's southeast lip; the corner is genuinely tight, and if the Centre's shape ever grows south-east he should be re-seated properly inside it. Both his chosen pictures render. Retires the old premise that Ferry has no HOME.md; he has one now, so it renders like any resident's home.*
