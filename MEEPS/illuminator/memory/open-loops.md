...
| **Town Centre as a region** (design) | Silver emitted (`Starstory PULSE/silver-2026-07-13_postmark-town-centre-as-region`); name-gated, needs a dev/prod lane before build. In-lane now: **write Ferry the letter** about his home in the Centre region (his to author/bless). | the silver; #289 (Gala host) | ⟳ | — |
